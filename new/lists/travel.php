...
<body style="background-image:url('../images/couple_mountain_peak_travel_64552_1920x1080.jpg')">
  ...
  <li role="presentation" class="btn"><a href="../logout.php"  class="btn-danger"><i><b>LogOut</b></i></a></li>
          ...
          <div class="col-md-8">
              ...
              <form class="navbar-form navbar-right" method="post" name="updateform" action="travel.php" onsubmit="validate();">
