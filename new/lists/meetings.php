...
<body style="background-image:url('../images/1_Zyh4sGY9XqIYPnUGV5lNXg.jpeg')">
  ...
  <li role="presentation" class="btn"><a href="../logout.php"  class="btn-danger"><i><b>LogOut</b></i></a></li>
          ...
          <div class="col-md-8">
              ...
              <form class="navbar-form navbar-right" method="post" name="updateform" action="meetings.php" onsubmit="validate();">
