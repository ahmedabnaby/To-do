...
<?php
    ...
    $result=mysqli_query($db,$sql);
        ...
        $_SESSION['listname'] = $row['name']; 
        $_SESSION['list_id'] = $row['id']; 
 
    
    
    $title = mysqli_real_escape_string($db, $_POST['title']); 
    $text = mysqli_real_escape_string($db,$_POST['text']);
    $sql = "INSERT INTO `tasks` (`title`, `todo`,  `user_id`,`list_id`) VALUES 
            ('$_POST[title]','$_POST[text]', '$_SESSION[id]','$_SESSION[id]')";
